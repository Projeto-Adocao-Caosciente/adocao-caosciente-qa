 ...
 *
 * @example
 * cy.elementExpected("button", "should", "visible", "The button is visible", "The button is not visible");
 */
...
Cypress.Commands.add(
  "expected",
  (value, assert, expected, customSuccessMessage, customFailureMessage) => {
    let customMessage;
