...
describe("ST07: Análise do Funcionamento da Página de Detalhes de um PET", () => {
  before(() => {
    ...
    formRegister.fillFormData(
      new formDto({ title: formData.title, questions: formData.questions })
    );
  });
  ...
  context("Context 01: Visualização das Informações do PET", () => {
    it("CT01: Visualizar os detalhes de um PET", () => {
    ...
    it("CT02: [Mockado] Visualizar os detalhes de um PET", () => {
      new Cypress.Promise(async (resolve) => {
  ...
  context(
    "Context 02: Validar Redirecionamento de Links na Página de Detalhes de um PET",
    () => {
